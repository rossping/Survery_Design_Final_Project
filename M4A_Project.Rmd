...
```{r, sentiment scores, warning=F, message=FALSE}
...
```{r, df_sentiment processing, warning=FALSE, message=FALSE}
df_sentiment%>%
...
```{r, sentiment score visualization, warning=FALSE, message=FALSE}
df_sentiment%>%
